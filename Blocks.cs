...
public static class Blocks
{
    public static readonly BlockDef[] All =
    {
        ...
        new("IronOre",   new Color(139,  90,  43, 255), 15,  false, 8, 1, 2),  // 7  drops iron
        new("Iron",      new Color(180, 160, 140, 255),  0,  false, 0, 0, 0),  // 8  inventory only
    };

    public static BlockDef Get(byte id) => id < All.Length ? All[id] : All[0];
    public static bool IsSolid(byte id) => id != 0 && id != 8;
}
